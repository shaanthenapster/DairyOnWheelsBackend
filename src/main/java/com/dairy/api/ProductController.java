...
public class ProductController {
    ...
    public ResponseEntity<?> addProducts(@RequestBody ProductUploadRequestDto dto) throws UserException {
        ...
        if (productId.isPresent()) {
            ...
            erdto.setException(CustomException.PRODUCT_SAVE_FAILED);
            erdto.getMsg().add("PRODUCT_UPLOAD_FAILED");
